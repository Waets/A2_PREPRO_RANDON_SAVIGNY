...
<a href="#one"><img src="img/Phantom.jpg" alt="Smiley face" width="80%"><br>PHANTOM Unmistakably Rolls-Royce</a> <hr>

<a href="#two"><img src="img/Ghost.jpg" alt="Smiley face" width="80%"><br>GHOST Effortless simplicity</a> <hr>

<a href="#three"><img src="img/Wraith.jpg" alt="Smiley face" width="80%"><br>WRAITH Power. Style. Drama</a> <hr>

<a href="#four"><img src="img/Dawn.jpg" alt="Smiley face" width="80%"><br>DAWN Strikingly seductive</a>


</section>


<section class="col-xs-12"><img src="img/clictonavigate.jpg" alt="Smiley face" >

	<div id="imagemodele"><img src="img/phantomsalon.jpg" alt="Smiley face" width="1300" height="700">
	<h2 class="textesurimage"><strong><center><a id="one">Phantom :</a></center></strong><br>A commanding presence, Phantom Family encapsulates contemporary luxury. Its signature design is complemented by modern features, with the potential to personalise it to the smallest detail. Born of the desire to build The Best Car in the World, Phantom is the result of complete creative and engineering freedom.
...
<div id="imagemodele3"><img src="img/wraithsalon.jpg" alt="Smiley face" width="1300" height="700">
<h2 class="textesurimage3"><strong><center><a id="three">Wraith :</a></center></strong><br>
...
<br>
<div id="imagemodele4"><img src="img/dawnsalon.jpg" alt="Smiley face" width="1300" height="700">
<h2 class="textesurimage4"><strong><center><a id="four">Dawn :</a></center></strong><br>
A Rolls-Royce like no other
